...
export default function Blog() {
  return (
    <>
      <Head>
        <title>Career Blog & Resume Tips | SwiftResume.io</title>
        <meta name="description" content="Read expert articles on resume writing, cover letters, job search tips, and career advice from SwiftResume.io." />
        <meta name="keywords" content="resume tips, cover letter tips, career blog, job search advice, SwiftResume.io" />
      </Head>
