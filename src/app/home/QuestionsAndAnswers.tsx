...
const QAS = [
    ...
    answer: (
      <>
        ...
        <p>
          ...
          SwiftResume.io saves time and prevents formatting mistakes by
  ...
  {
    question:
      "Q2. What uniquely sets SwiftResume.io apart from other resume builders and templates?",
    answer: (
      <>
        <p>
          Other than SwiftResume.io, there are some great free resume builders out
          there, e.g. <Link href="https://rxresu.me/">Reactive Resume</Link>,{" "}
          <Link href="https://flowcv.com/">FlowCV</Link>. However, SwiftResume.io
          stands out with 2 distinctive features:
        </p>{" "}
        <p>
          <span className="font-semibold">
            1. SwiftResume.io is designed specifically for the U.S. job market and
            best practices.
          </span>
          <br />
          Unlike other resume builders that target a global audience and offer
          many customization options, SwiftResume.io intentionally only offers
          ...
          like references. Additionally, SwiftResume.io only offers a top down
          single column resume design as opposed to two column design, because
          single column design works best for AST. <br />{" "}
        </p>
        <p>
          <span className="font-semibold">
            2. SwiftResume.io is super privacy focus.
          </span>{" "}
          <br />
          While other resume builders may require email sign up and store user
          data in their databases, SwiftResume.io believes that resume data should
          remain private and accessible only on user’s local machine. Therefore,
          SwiftResume.io doesn’t require sign up to use the app, and all inputted
  ...
  {
    question: "Q3. Who created SwiftResume.io and why?",
    answer: (
      <>
        <p>
          SwiftResume.io was created by lau pro and designed by mxy as a weekend project. As immigrants to the US, we had made many mistakes
          ...
          that led to SwiftResume.io, where we integrated best practices and our
          knowledge into this resume builder. Our hope is that SwiftResume.io can help
  ...
  {
    question: "Q4. How can I support SwiftResume.io?",
    answer: (
      <>
        <p>
          The best way to support SwiftResume.io is to share your thoughts and
          feedback with us to help further improve it. Whether you like it or not, we would love to
          hear from you.
        </p>
        <p>
          Another great way to support SwiftResume.io is by spreading the words.
